...
!!! note
    This function's behavior was changed in REV01; in REV00, it worked the same as [its equivalent function in RSDKv3](/RSDKv3/RetroScript/Functions/Drawing/SetPaletteFade).
