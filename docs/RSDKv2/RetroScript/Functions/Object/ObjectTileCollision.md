...
!!! note
    This function is best used for checking if a tile is present. For moving along tiles, use [ObjectTileGrip()](ObjectTileGrip.md) instead.
