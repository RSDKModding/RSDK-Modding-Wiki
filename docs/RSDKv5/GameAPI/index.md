...
GameAPI is a custom-made bindings API for games made for [Retro Engine v5](/RSDKv5), specifically for its [decompilation](/RSDKv5/Decompilation). The API is available for both C and C++. The C bindings are based on RSDKv5 Object Code when transpiled to C, whereas the C++ bindings are based loosely on [Sonic 3 & Knuckles](/Games/Sonic3K)' C++ code.
