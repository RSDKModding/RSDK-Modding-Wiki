...
S3KOEditorLink is an RSDKv5U logic file that allows accessing editor renders and variables from [Sonic Origins]'s [Sonic 3 & Knuckles] remaster in an RSDK editor program such as [RetroED](RetroED/index.md).

!!! warning
    S3KOEditorLink is only compatible with Windows and requires owning the Steam version of [Sonic Origins].

!!! note
    S3KOEditorLink only works with RSDK editor programs; it **does not** allow playing [Sonic 3 & Knuckles] in the [RSDKv5U Decompilation](/RSDKv5/Decompilation).

  [Sonic Origins]: /Games/SonicOrigins
  [Sonic 3 & Knuckles]: /Games/Sonic3K
