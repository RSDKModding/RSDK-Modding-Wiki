...
This wiki is written in Markdown, just like GitHub's own Markdown files! One of the best ways to write Markdown text files for Zensical sites is to use [Visual Studio Code](https://code.visualstudio.com/) with the [Zensical Studio](https://zensical.org/studio/) extension, which allows you to preview the page you are currently typing by clicking the `Open Preview` button on top of the active editor. To see how your changes look on the full website, you absolutely should setup the website locally by following the instructions in the [Testing](#testing) section.
